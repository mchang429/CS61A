...
class Place(object):
    ...
    def remove_insect(self, insect):
        ...
        if insect.is_ant:
            ...
            if insect.name == 'Queen' and insect.number == 1:
                return
...
class Ant(Insect):
    ...
    def can_contain(self, other):
        return self.container and self.ant is None and other.ant is None and other.container is False
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, hive):
        ...
        i = 0
        closest_place = None
        while closest_place == None and look is not hive and i <= self.max_range:
            if len(look.bees) == 0 or i < self.min_range:
                look = look.entrance
                i += 1
            else:
                closest_place = look
        if closest_place == None:
            return None
        return random_or_none(look.bees)
        # END Problem 3B
...
class QueenAnt(ScubaThrower):  # You should change this line
    ...
    def __init__(self):
        ...
        self.number = QueenAnt.number_of_queens
        self.place = QueenPlace(self.place)
    ...
    def action(self, colony):
        ...
        def backwards():
            current_spot = self.place
            while current_spot != None:
                buff_this_ant = current_spot.ant
                if buff_this_ant != None:
                    if buff_this_ant.container == True and buff_this_ant.ant != None:
                        if buff_this_ant.ant.name  != 'Queen' and not buff_this_ant.ant.doubled:
                            buff_this_ant = buff_this_ant.ant
                            buff_this_ant.damage = buff_this_ant.damage*2
                            buff_this_ant.doubled = True
                    if not buff_this_ant.doubled:
                        if current_spot.ant.name != 'Queen':
                            buff_this_ant.damage = buff_this_ant.damage*2
                            buff_this_ant.doubled = True
                current_spot = current_spot.exit
