...
(define (make-suber num)
  (lambda (x) (- x num))
)
(define suber (make-suber 9))
(suber 20)
;expect 11
...
(define b (cons 6 (cons 9 (cons 10 nil))))
b
;expect (6 9 10)
...
;Mu Form Test
(define subx (mu (x) (- y x)))
(define sub2xy (lambda (x y) (subx (- x x))))
(sub2xy 3 6)
;expect 6
